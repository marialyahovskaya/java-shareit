...
public class ItemRequestClient extends BaseClient {
    ...
    @Autowired
    public ItemRequestClient(@Value("${shareit-server.url:default}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
    ...
    public ResponseEntity<Object> findItemRequestsByRequestorId(Long userId) {
        return get("", userId);
    }
